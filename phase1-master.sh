...
aws s3 --profile cc-user \
    cp dkpro-c4corpus-hadoop/target/dkpro-c4corpus-hadoop-1.0.0-SNAPSHOT.jar \
...
aws emr create-cluster \
    --name "C4Corpus phase 1 - 1.0.0-SNAPSHOT master - 2 x m4.x4large + 8 x m4.4xlarge 400 file sample $CRAWL" \
    --profile cc-user \
    --auto-terminate \
    --region us-east-1 \
    ...
    --steps '[
        ...
        "s3://tfmorris/c4corpus/cc-phase1out-'$CRAWL'-1pct-master-forreal"],
        "Type":"CUSTOM_JAR",
